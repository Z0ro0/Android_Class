...
public class MainActivity extends AppCompatActivity {
    ...
    Switch swStart;
    EditText edtName, edtMid, edtFinal, edtPerf, edtAtt;
    RadioGroup rgGrade;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edtAtt = findViewById(R.id.edtAtt);
        ...
        btnCal.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                int attend = Integer.parseInt(edtAtt.getText().toString());
                ...
                else if(total>=0)s= "E학점";
                

                String out = grade + "학년" + name+" 님의 총점:" + total + "\n" + "학점: " + s;
